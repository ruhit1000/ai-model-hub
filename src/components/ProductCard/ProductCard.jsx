...
const ProductCard = ({ product, handleAddToCart, cart }) => {
    ...
    return (
        <div className='group max-w-sm mx-auto rounded-2xl border border-base-300 shadow-xl'>
            ...
            <div className='px-4 py-4 space-y-3'>
                ...
                <button onClick={() => handleAddToCart(product)} className={`w-full ${ existingProduct ? 'bg-red-500' : 'bg-orange-500'} py-3 rounded-2xl text-base-100 font-medium cursor-pointer`}>
